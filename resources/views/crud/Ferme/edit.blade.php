        ...
        <x-form.form
            ...
            <div class="col-12 row">
                <x-form.card col="col-12 row" title="{{ ucwords(trans('pages/fermes.edit_form_title')) }}">
                    ...
                    <div class="col-2">
                        <x-form.file name="logo" label="{{ trans('words.logo') }}" />
                    </div>
                    <div class="col-10 row">
                        <x-form.input required col="col-12 col-sm-6" name="nomDomaine" label="{{ trans('words.nomDomaine') }}" />
                        <x-form.select col="col-12 col-sm-6" name="fullNameG" label="fullNameG" :bind-with="[\App\Models\Ferme::all(), ['id', 'fullNameG']]" />
