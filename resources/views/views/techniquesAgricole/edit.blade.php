...
@section('content')
    ...
    <x-form.card col="col-12 row" title="Historique">
        ...
        <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
            ...
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#kt_techniquesSpecifiques">techniques Specifiques</a>
            </li>
        </ul>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show" id="kt_techniquesSpecifiques" role="tabpanel">
                ...
                <x-table.data-table
                    ...
                    edit-route="techniquesSpecifiques.show"
                    delete-route="techniquesSpecifiques.delete"
                />
                @endBinding
            </div>
